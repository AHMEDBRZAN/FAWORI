            ...
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: Image.asset('assets/images/logo.png',
                              ...
                              errorBuilder: (_, __, ___) => const FaworiLogoWrap()))),
                  ...
                  Text(s.isArabic ? 'سجّل دخولك للمتابعة' : 'Sign in to continue',
...
class FaworiLogoWrap extends StatelessWidget {
  const FaworiLogoWrap({super.key});
  @override
  Widget build(BuildContext context) => Container(
      width: 96, height: 96, color: AppColors.orange.withAlpha(40),
      child: const Icon(Icons.store_rounded, size: 44, color: AppColors.orange));
}
